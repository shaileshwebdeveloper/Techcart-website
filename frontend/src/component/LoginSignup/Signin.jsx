        ...
        <div>
            ...
            <Box>
                ...
                >
                    ...
                    <Box h={{ sm: '30vh', md: '52vh', lg: '83vh' }} boxShadow='xl' w={['80%', '420px']} bg='white' p='35px' textAlign={'left'} m='auto' display={'inline-block'} mt='90px' borderRadius='8px'>
                        <form onSubmit={(e) => submit(e)}>
                            ...
                            <Stack mt='20px' spacing={4} direction='column' >
                                <Button type='submit' bg='#1b7dfd' p='25px' fontSize={'16px'} colorScheme='green' color='white'>Sign In</Button>
                                ...
                                <Link to='/create'><Button w='100%' bg='#afa5a53b' p='25px' fontSize={'16px'} fontWeight='semibold' colorScheme='green' color='blackAlpha.700' >Create a new account</Button></Link>
                            </Stack>
                        </form>
                        <Box mt='40px'>
                            <Flex gap={"15px"}>
